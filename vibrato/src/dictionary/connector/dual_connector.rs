...
use crate::dictionary::connector::raw_connector::scorer::{Scorer, U31x8, SIMD_SIZE};
...
impl DualConnector {
        ...
        C: Read,
    {
        ...
        Ok(Self {
            ...
            right_id_map,
            left_id_map,
            raw_right_ids: U31x8::to_simd_vec(&right_ids),
            raw_left_ids: U31x8::to_simd_vec(&left_ids),
            scorer: scorer_builder.build(),
        })
    }
}
...
impl ConnectorCost for DualConnector {
    ...
    fn cost(&self, right_id: u16, left_id: u16) -> i32 {
        ...
        let raw_cost = self.scorer.accumulate_cost(
